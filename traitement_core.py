...
MAPPING_COLONNES = {
    ...
    "Nom Prénom": [
        "full_name", "Nom Prénom", "nom_complet", "nom complet", "last_name",
        "nom", "name", "surname", "famille"
    ],
    "Email": [
        "email", "e-mail", "Email", "mail", "email_address", "adresse_email",
        "adresse mail", "adresse e-mail"
    ],
    "Code Postal": [
        "code postal", "Code Postal", "code_postal", "post_code", "zip_code",
        "postal_code", "cp", "postcode", "zip", "codepostal"
    ],
    "Téléphone": [
        "numero de telephone", "Téléphone", "numéro_de_téléphone",
        "numéro de téléphone", "phone_number", "phone",
